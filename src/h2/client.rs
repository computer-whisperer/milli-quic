...
/// HTTP/2 client.
pub struct H2Client<const MAX_STREAMS: usize = 64, const BUF: usize = 16384> {
    inner: H2Connection<MAX_STREAMS, BUF>,
}

impl<const MAX_STREAMS: usize, const BUF: usize> H2Client<MAX_STREAMS, BUF> {
...
impl<const MAX_STREAMS: usize, const BUF: usize> Default for H2Client<MAX_STREAMS, BUF> {
    fn default() -> Self {
        Self::new()
    }
}
